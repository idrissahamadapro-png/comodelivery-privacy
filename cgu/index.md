---
title: ComoDelivery — Conditions Générales d'Utilisation
layout: default
---
...
- Fournir des informations exactes (nom, téléphone, adresse, email).
...
- ne pas tenter de pirater, désassembler ou rétro-ingéniérer l'application,
- ne pas harceler ou menacer les restaurateurs, livreurs ou autres utilisateurs,
- respecter les livreurs et les restaurateurs lors des interactions,
- fournir des adresses de livraison correctes et accessibles.

ComoDelivery se réserve le droit de suspendre ou résilier tout compte violant ces règles, sans préavis.
...
Si un problème survient (commande non reçue, plat erroné, plat froid, etc.) :
1. Signalez le litige dans l'application (Reçu de la commande → « Signaler un problème »).
2. Délai : 30 minutes après livraison (24h pour les non-réceptions).
3. Notre équipe traite le litige sous 24h ouvrées.
4. Si le litige est validé en votre faveur, le remboursement Stripe est **automatique** sur votre carte sous 5-10 jours ouvrés.
...
Tout le contenu de l'application (design, logo, code, textes, photos) est la propriété exclusive de ComoDelivery. Toute reproduction sans autorisation écrite est interdite.
...
Le traitement de vos données personnelles est régi par notre [Politique de confidentialité](/privacy/), conforme au RGPD.

## 10. Modifications des CGU

Nous pouvons modifier ces CGU à tout moment. Toute modification substantielle vous sera notifiée par email et lors de votre prochaine connexion à l'application. La poursuite de l'utilisation du Service après modification vaut acceptation des nouvelles CGU.
...
[← Retour à l'accueil](/) · [Politique de confidentialité](/privacy/) · [CGV](/cgv/)
